...
# -*- coding: utf-8 -*-
"""
Created on Sat Jul  6 13:46:52 2019
...
class MultiTaskTrainer(Registrable):
    def __init__(
        ...
        self._tensorboard = TensorboardWriter(get_batch_num_total =lambda: self._batch_num_total,  serialization_dir = self._serialization_dir)
